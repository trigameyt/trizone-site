...
function splitSqlStatements(source) {
  // Retire les commentaires de ligne AVANT de parser les quotes.
  // Sinon une apostrophe dans un commentaire (ex: d'éviter) peut ouvrir
  // une chaîne SQL et empêcher la séparation des requêtes suivantes.
