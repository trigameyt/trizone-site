...
3. Il choisit Copper, Iron, Gold, Diamond ou Netherite dans la boutique.
...
```text
STRIPE_PRICE_COPPER_ID=price_...
STRIPE_PRICE_IRON_ID=price_...
STRIPE_PRICE_GOLD_ID=price_...
STRIPE_PRICE_DIAMOND_ID=price_...
STRIPE_PRICE_NETHERITE_ID=price_...
```
...
DISCORD_BOT_TOKEN=...
DISCORD_GUILD_ID=...
DISCORD_ROLE_COPPER_ID=...
DISCORD_ROLE_IRON_ID=...
DISCORD_ROLE_GOLD_ID=...
DISCORD_ROLE_DIAMOND_ID=...
DISCORD_ROLE_NETHERITE_ID=...
